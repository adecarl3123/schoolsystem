...
$result_count = mysqli_query($conn, "SELECT COUNT(*) as total_records FROM crud") or die(mysqli_error($conn));
//total records
...
//query string
$sql = "SELECT * FROM crud LIMIT $offset , $total_records_per_page";
//result
    ...
    <div class="side-menu">
        ...
        <h1 style="color:white">Admin</h1>
            ...
            <ul>
                ...
                <li> <a href="login/registeradmin.php" style="color:white"> <img src="images/teacher2.png"> &nbsp; <span> Teachers </span></li> </a>
        ...
        <div class="header">
            <div class="nav">
                <div class="search">
                    ...
                    <h1> College Student Information System </h1>
    ...
    ?>
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="add_student.php" class="btn btn-flat btn-sm btn-primary mb-3"> <i class="fa fa-add"></i> Add New Student 
                </a> 
                <a href="search_student.php" class="    btn btn-flat btn-sm btn-info float-end mb-3"> <i class="fa fa-search"> </i> Search Student </a>  
            </div>
                            ...
                            while ($row = mysqli_fetch_array($result)) { ?>
                                 ...
                                 <tr> 
                                        ...
                                        <td> 
                                            ...
                                            fs-5 me-3"></i></a>
                                            <a href="delete_student.php?id=<?php echo $row['id'] ?>" onclick="return confirm('Are you sure you want to delete this student?');" class="link-dark"><i class="fa-solid fa-trash fs-5"></i></a>   
                                        </td>
                                 </tr>
